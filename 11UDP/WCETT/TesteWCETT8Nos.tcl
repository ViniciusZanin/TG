...
#Simualcao com 8 nos utilizando protocolo WCETT com a grade tendo 500 x 500
#Define as opcoes
...
set tracefd       [open TesteWCETT8Nos.tr w] 
set windowVsTime2 [open winTesteWCETT8Nos.tr w] 
set namtrace      [open simwrlsTesteWCETT8Nos.nam w]
...
$node_(5) set X_ 284.0
$node_(5) set Y_ 242.0
$node_(5) set Z_ 0.0

$node_(4) set X_ 254.0
$node_(4) set Y_ 120.0
$node_(4) set Z_ 0.0

$node_(3) set X_ 409.0
$node_(3) set Y_ 367.0
$node_(3) set Z_ 0.0

$node_(2) set X_ 253.0
$node_(2) set Y_ 10.0
$node_(2) set Z_ 0.0
