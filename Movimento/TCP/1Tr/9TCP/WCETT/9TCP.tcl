...
#Simualcao com 9 nos utilizando protocolo AODV com a grade tendo 500 x 500
#Define as opcoes
...
set tracefd       [open 9TCP.tr w] 
set windowVsTime2 [open win9TCP.tr w] 
set namtrace      [open simwrls9TCP.nam w]
...
$ns at 100.0 "$node_(4) setdest 241.0 362.0 3.0"
$ns at 17.0 "$node_(4) setdest 35.0 462.0 3.0"
