...
set tracefd       [open 23UDP.tr w] 
set windowVsTime2 [open win23UDP.tr w] 
set namtrace      [open simwrls23UDP.nam w]
...
$ns attach-agent $node_(18) $null_(3)
...
$ns at 15.0 "$cbr_(3) start"
 #Define a conexao UDP entre 3 e18 Comecando em 15.0
set udp_(2) [new Agent/UDP]
$ns attach-agent $node_(3) $udp_(2)
set null_(2) [new Agent/Null]
$ns attach-agent $node_(18) $null_(2)
...
$ns at 15.0 "$cbr_(2) start"
 #Define a conexao UDP entre 7 e11 Comecando em 15.0
set udp_(1) [new Agent/UDP]
$ns attach-agent $node_(7) $udp_(1)
set null_(1) [new Agent/Null]
$ns attach-agent $node_(11) $null_(1)
