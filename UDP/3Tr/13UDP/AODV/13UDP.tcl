...
#Simualcao com 12 nos utilizando protocolo DSR com a grade tendo 500 x 500
#Define as opcoes
...
set tracefd       [open 13UDP.tr w] 
set windowVsTime2 [open win13UDP.tr w] 
set namtrace      [open simwrls13UDP.nam w]
...
$node_(0) set Z_ 0.0
 ...
 #Define a conexao UDP entre 0 e10 Comecando em 15.0
set udp_(3) [new Agent/UDP]
$ns attach-agent $node_(0) $udp_(3)
set null_(3) [new Agent/Null]
$ns attach-agent $node_(10) $null_(3)
...
$ns at 15.0 "$cbr_(3) start"
 #Define a conexao UDP entre 1 e10 Comecando em 15.0
set udp_(2) [new Agent/UDP]
$ns attach-agent $node_(1) $udp_(2)
set null_(2) [new Agent/Null]
$ns attach-agent $node_(10) $null_(2)
...
$ns at 15.0 "$cbr_(2) start"
 #Define a conexao UDP entre 5 e6 Comecando em 15.0
set udp_(1) [new Agent/UDP]
$ns attach-agent $node_(5) $udp_(1)
set null_(1) [new Agent/Null]
$ns attach-agent $node_(6) $null_(1)
