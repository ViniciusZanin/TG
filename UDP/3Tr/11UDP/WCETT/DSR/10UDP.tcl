...
set tracefd       [open 10UDP.tr w] 
set windowVsTime2 [open win10UDP.tr w] 
set namtrace      [open simwrls10UDP.nam w]
...
$ns at 15.0 "$cbr_(2) start"
 #Define a conexao UDP entre 3 e2 Comecando em 15.0
set udp_(1) [new Agent/UDP]
$ns attach-agent $node_(3) $udp_(1)
set null_(1) [new Agent/Null]
$ns attach-agent $node_(2) $null_(1)
