...
set tracefd       [open 27UDP.tr w] 
set windowVsTime2 [open win27UDP.tr w] 
set namtrace      [open simwrls27UDP.nam w]
...
$ns attach-agent $node_(19) $null_(3)
...
$ns at 15.0 "$cbr_(3) start"
 #Define a conexao UDP entre 1 e23 Comecando em 15.0
set udp_(2) [new Agent/UDP]
$ns attach-agent $node_(1) $udp_(2)
set null_(2) [new Agent/Null]
$ns attach-agent $node_(21) $null_(2)
...
$ns at 15.0 "$cbr_(2) start"
 #Define a conexao UDP entre 3 e21 Comecando em 15.0
set udp_(1) [new Agent/UDP]
$ns attach-agent $node_(24) $udp_(1)
set null_(1) [new Agent/Null]
$ns attach-agent $node_(25) $null_(1)
