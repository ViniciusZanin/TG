...
#Simualcao com 13 nos utilizando protocolo AODV com a grade tendo 500 x 500
#Define as opcoes
...
set tracefd       [open 13NosUDP.tr w] 
set windowVsTime2 [open win13NosUDP.tr w] 
set namtrace      [open simwrls13NosUDP.nam w]
...
$node_(0) set Z_ 0.0
 ...
 #Define a conexao UDP entre 0 e12 Comecando em 10.0
set udp_(1) [new Agent/UDP]
$ns attach-agent $node_(0) $udp_(1)
set null_(1) [new Agent/Null]
$ns attach-agent $node_(12) $null_(1)
set cbr_(1) [new Application/Traffic/CBR]
$cbr_(1) set packetSize_ 512
$cbr_(1) set interval_ 0.01
$cbr_(1) set random_ 23
$cbr_(1) set maxpkts_ 10000
$cbr_(1) attach-agent $udp_(1)
$ns connect $udp_(1) $null_(1)
$ns at 10.0 "$cbr_(1) start"
