...
set tracefd       [open 8UDP2Tr.tr w] 
set windowVsTime2 [open win8UDP2Tr.tr w] 
set namtrace      [open simwrls8UDP2Tr.nam w]
...
$ns attach-agent $node_(0) $udp_(2)
set null_(2) [new Agent/Null]
$ns attach-agent $node_(7) $null_(2)
...
$ns at 15.0 "$cbr_(2) start"
 #Define a conexao UDP entre 1 e6 Comecando em 15.0
