...
set tracefd       [open Aleatorio2TRTCP.tr w] 
set windowVsTime2 [open winAleatorio2TRTCP.tr w] 
set namtrace      [open simwrlsAleatorio2TRTCP.nam w]
...
#Define a conexao TCP entre 1 e 3 Comecando em 15.0
...
#Define a conexao TCP entre 5 e 3 Comecando em 15.0
set tcp [new Agent/TCP/Newreno]
$tcp set class_ 2
set sink [new Agent/TCPSink]
